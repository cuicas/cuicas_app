...
class __TwigTemplate_34bbb6585c74d399803876608e9ec9a09eb88e1d9a3e216ff56534d2d661a3d8 extends Twig_Template
{
...
\t\t\t\t\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["circuito"]) {
                // line 36
                echo "\t\t\t\t\t\t\t<option value=\"";
                echo twig_escape_filter($this->env, twig_template_get_attributes($this, $context["circuito"], "getId", array(), "method"), "html", null, true);
                echo "\">";
