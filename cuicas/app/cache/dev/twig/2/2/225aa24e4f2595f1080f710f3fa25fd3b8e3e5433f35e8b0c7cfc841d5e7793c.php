...
class __TwigTemplate_225aa24e4f2595f1080f710f3fa25fd3b8e3e5433f35e8b0c7cfc841d5e7793c extends Twig_Template
{
...
\t\t\t\t<strong>";
        // line 74
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, (isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "roles", array()), 'label');
        echo "</strong>
\t\t\t\t";
        // line 75
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock(twig_template_get_attributes($this, (isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "roles", array()), 'widget');
        echo "
\t\t\t</div>
\t\t</div>
\t\t<div class=\"row\">
