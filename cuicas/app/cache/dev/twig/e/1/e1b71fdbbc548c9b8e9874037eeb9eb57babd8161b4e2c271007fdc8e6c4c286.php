...
/* EncuestasBundle:Encuestas:detalleVentana2.html.twig */
class __TwigTemplate_e1b71fdbbc548c9b8e9874037eeb9eb57babd8161b4e2c271007fdc8e6c4c286 extends Twig_Template
{
  ...
  ";
    ...
    ";
        ...
        <table class=\"table stacktable table-hover\" border=\"1\">
         ...
         <h2><strong>¿Va a votar en las elecciones reginales de gobernadores?</strong></h2>
        <table class=\"table stacktable table-hover\" border=\"1\">
            <thead>
              <th> Estado</th>
            ...
            <tbody>
               ";
                // line 282
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable(twig_template_get_attributes($this, (isset($context["datosGenerales"]) ? $context["datosGenerales"] : $this->getContext($context, "datosGenerales")), "estados", array()));
                foreach ($context['_seq'] as $context["_key"] => $context["estado"]) {
                    // line 283
                    echo "                <tr>
                  <td>";
                    // line 284
                    echo twig_escape_filter($this->env, twig_template_get_attributes($this, $context["estado"], "estado", array()), "html", null, true);
                    echo "</td>
                  <td width=\"70\" align=\"center\"><strong>";
                    // line 285
                    echo twig_escape_filter($this->env, twig_template_get_attributes($this, $context["estado"], "si", array()), "html", null, true);
                    echo "</strong></td>
                  <td width=\"70\" align=\"center\"><strong>";
                    // line 286
                    echo twig_escape_filter($this->env, twig_template_get_attributes($this, $context["estado"], "no", array()), "html", null, true);
                    echo "</strong></td>
                  <td width=\"70\" align=\"center\"><strong>";
                    // line 287
                    echo twig_escape_filter($this->env, twig_template_get_attributes($this, $context["estado"], "total", array()), "html", null, true);
                    echo "</strong></td>
                </tr>
