...
class __TwigTemplate_dcc509aa59d3212fd14b210b8ea3a8fbb2efc512e05f03e898b18336a83d3f6a extends Twig_Template
{
      ...
      <table border=\"1\">
        <thead>
          ...
          ";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["parroquia"]) ? $context["parroquia"] : $this->getContext($context, "parroquia")), "centroVotacion", array()));
            foreach ($context['_seq'] as $context["_key"] => $context["centrosVotacion"]) {
                // line 39
                echo "            ";
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($context["centrosVotacion"], "cvCandidatos", array()));
                foreach ($context['_seq'] as $context["_key"] => $context["cvCandidato"]) {
                    if ((($this->getAttribute($context["cvCandidato"], "idParroquia", array()) == (isset($context["id_parroquia"]) ? $context["id_parroquia"] : $this->getContext($context, "id_parroquia"))) && ($this->getAttribute($context["cvCandidato"], "idEncuesta", array()) == $this->getAttribute((isset($context["encuesta"]) ? $context["encuesta"] : $this->getContext($context, "encuesta")), "id", array())))) {
                        // line 40
                        echo "              ";
                        // line 41
                        echo "                
                ";
                        // line 42
                        if ((($this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "partido", array()) == "psuv") || ($this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "partido", array()) == "psuv-gpp"))) {
                            // line 43
                            echo "                  ";
                            $context["totalVotos1"] = ((isset($context["totalVotos1"]) ? $context["totalVotos1"] : $this->getContext($context, "totalVotos1")) + $this->getAttribute($context["cvCandidato"], "votos", array()));
                            // line 44
                            echo "                  ";
                            $context["totalVotosLista1"] = ((isset($context["totalVotosLista1"]) ? $context["totalVotosLista1"] : $this->getContext($context, "totalVotosLista1")) + $this->getAttribute($context["cvCandidato"], "votosLista", array()));
                            // line 45
                            echo "                  ";
                            $context["candidato1"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "apellidoNombre", array());
                            // line 46
                            echo "                  ";
                            $context["partido1"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "partido", array());
                            // line 47
                            echo "                  ";
                            $context["foto1"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "rutaFoto", array());
                            // line 48
                            echo "                ";
                        }
                        // line 49
                        echo "                 ";
                        if (($this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "partido", array()) == "mud")) {
                            // line 50
                            echo "                  ";
                            $context["totalVotos2"] = ((isset($context["totalVotos2"]) ? $context["totalVotos2"] : $this->getContext($context, "totalVotos2")) + $this->getAttribute($context["cvCandidato"], "votos", array()));
                            // line 51
                            echo "                  ";
                            $context["totalVotosLista2"] = ((isset($context["totalVotosLista2"]) ? $context["totalVotosLista2"] : $this->getContext($context, "totalVotosLista2")) + $this->getAttribute($context["cvCandidato"], "votosLista", array()));
                            // line 52
                            echo "                  ";
                            $context["candidato2"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "apellidoNombre", array());
                            // line 53
                            echo "                  ";
                            $context["partido2"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "partido", array());
                            // line 54
                            echo "                  ";
                            $context["foto2"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "rutaFoto", array());
                            // line 55
                            echo "                ";
                        }
                        echo " 
                 ";
                        // line 56
                        if (($this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "partido", array()) == "otros")) {
                            // line 57
                            echo "                  ";
                            $context["totalVotos3"] = ((isset($context["totalVotos3"]) ? $context["totalVotos3"] : $this->getContext($context, "totalVotos3")) + $this->getAttribute($context["cvCandidato"], "votos", array()));
                            // line 58
                            echo "                  ";
                            $context["totalVotosLista3"] = ((isset($context["totalVotosLista3"]) ? $context["totalVotosLista3"] : $this->getContext($context, "totalVotosLista3")) + $this->getAttribute($context["cvCandidato"], "votosLista", array()));
                            // line 59
                            echo "                  ";
                            $context["candidato3"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "apellidoNombre", array());
                            // line 60
                            echo "                  ";
                            $context["partido3"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "partido", array());
                            // line 61
                            echo "                  ";
                            $context["foto3"] = $this->getAttribute($this->getAttribute($context["cvCandidato"], "candidato", array()), "rutaFoto", array());
                            // line 62
                            echo "                ";
                        }
                        echo "                
...
<div class=\"titulo\">
  <div align=\"center\" >Parroquia ";
        // line 94
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["parroquia"]) ? $context["parroquia"] : $this->getContext($context, "parroquia")), "nombreParroquia", array()), "html", null, true);
        echo " </div>
</div>
...
<div class=\"botones_menu\" style=\"position: absolute; top: 50px; \">
  <a href=\"";
        // line 99
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("mapas_estadisticos_detalle_municipio_ventana", array("id_municipio" => $this->getAttribute($this->getAttribute((isset($context["parroquia"]) ? $context["parroquia"] : $this->getContext($context, "parroquia")), "municipio", array()), "id", array()))), "html", null, true);
        echo "\">Regresar al Mcpio. ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["parroquia"]) ? $context["parroquia"] : $this->getContext($context, "parroquia")), "municipio", array()), "nombreMunicipio", array()), "html", null, true);
        echo "<br> 
...
";
  ...
  ";
        // line 106
        echo $this->getAttribute($this, "boton", array(0 => $this->getAttribute($this->getAttribute((isset($context["parroquia"]) ? $context["parroquia"] : $this->getContext($context, "parroquia")), "municipio", array()), "id", array())), "method");
        echo "
    ...
    <table border=\"1\">
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cv"]) {
            // line 123
            echo "        <tr><td><strong>";
            echo twig_escape_filter($this->env, $this->getAttribute($context["cv"], "nombreCentro", array()), "html", null, true);
            echo "</strong></td><tr>
      ";
        }
        $_parent = $context['_parent'];
