...
class __TwigTemplate_d06d595e33402cb8d3dd8c6815a4898f3ba12c9d9e5f0703c13211a28c492012 extends Twig_Template
{
    ...
    <div class=\"col-xs-12 col-md-3\">
      <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["candidato"]) {
            // line 116
            echo "                    ";
            if ($this->getAttribute($context["candidato"], "apellidoNombre", array(), "any", true, true)) {
                // line 117
                echo "                      <td width=130><strong>";
                echo twig_escape_filter($this->env, $this->getAttribute($context["candidato"], "apellidoNombre", array()), "html", null, true);
                echo "</strong><br><img class=\"img-rounded\" alt=\"Imagen\" title=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($context["candidato"], "apellidoNombre", array()), "html", null, true);
                echo "\" id=\"img\" src=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl((("imagenes/fotosCandidatos/" . $this->getAttribute($context["candidato"], "rutaFoto", array())) . "")), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cant_mesas"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["candidato"]) {
                ...
                if ($this->getAttribute($context["candidato"], "apellidoNombre", array(), "any", true, true)) {
                    ...
                    // line 134
                    echo "                      ";
                    $context["mesaActual"] = $this->getAttribute($this->getAttribute($this->getAttribute($context["loop"], "parent", array()), "loop", array()), "index", array());
                    // line 135
                    echo "                      ";
                    $context['_parent'] = (array) $context;
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["votoMesa"]) {
                        // line 136
                        echo "                        ";
                        if (((($this->getAttribute($this->getAttribute($context["votoMesa"], "candidato", array()), "id", array()) == $this->getAttribute($context["candidato"], "id", array())) && ($this->getAttribute($context["votoMesa"], "nroMesa", array()) == (isset($context["mesaActual"]) ? $context["mesaActual"] : $this->getContext($context, "mesaActual")))) && ($this->getAttribute($this->getAttribute(                        // line 137
$context["votoMesa"], "centroVotacion", array()), "id", array()) == $this->getAttribute((isset($context["cv"]) ? $context["cv"] : $this->getContext($context, "cv")), "id", array())))) {
                            // line 138
                            echo "                          ";
                            $context["valueVoto"] = $this->getAttribute($context["votoMesa"], "votos", array());
                            // line 139
                            echo "                          ";
                            $context["valueVotoLista"] = $this->getAttribute($context["votoMesa"], "votosLista", array());
                            // line 140
                            echo "                        ";
                        }
                        // line 141
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($context["loop"], "parent", array()), "loop", array()), "index", array()), "html", null, true);
                    echo "\" name=\"form[";
                    echo twig_escape_filter($this->env, (($this->getAttribute($context["candidato"], "id", array()) . "_") . $this->getAttribute($this->getAttribute($this->getAttribute($context["loop"], "parent", array()), "loop", array()), "index", array())), "html", null, true);
