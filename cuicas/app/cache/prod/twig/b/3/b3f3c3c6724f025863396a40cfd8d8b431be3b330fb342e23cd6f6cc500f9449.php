...
class __TwigTemplate_b3f3c3c6724f025863396a40cfd8d8b431be3b330fb342e23cd6f6cc500f9449 extends Twig_Template
{
...
\t\t\t\t\t";
            // line 40
            $context["rol"] = $this->getAttribute($context["usuario"], "getRol", array());
            // line 41
            echo "\t\t\t\t\t";
            if (($this->getAttribute($context["usuario"], "getRol", array()) == "ROLE_ADMIN")) {
                // line 42
                echo "\t\t\t\t\t\t";
            ...
            // line 44
            echo "\t\t\t\t\t";
            if (($this->getAttribute($context["usuario"], "getRol", array()) == "ROLE_USUARIO")) {
                // line 45
                echo "\t\t\t\t\t\t";
                $context["rol"] = "Usuario";
                // line 46
            ...
            // line 47
            echo "\t\t\t\t\t";
            if (($this->getAttribute($context["usuario"], "getRol", array()) == "ROLE_SUPERVISOR")) {
                // line 48
                echo "\t\t\t\t\t\t";
            ...
            echo "</td>
                                        <td><a href=\"";
            // line 51
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("usuario_eliminar", array("usuario_id" => $this->getAttribute($context["usuario"], "id", array()))), "html", null, true);
