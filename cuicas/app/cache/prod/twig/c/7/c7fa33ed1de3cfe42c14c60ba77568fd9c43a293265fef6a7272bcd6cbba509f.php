...
class __TwigTemplate_c7fa33ed1de3cfe42c14c60ba77568fd9c43a293265fef6a7272bcd6cbba509f extends Twig_Template
{
...
\t\t\t\t\t";
        // line 34
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "_username", array()), 'widget', array("attr" => array("placeholder" => "Correo electrónico")));
        echo "
\t\t\t\t\t\t\t\t";
        // line 36
        echo "\t\t\t\t</div>
...
\t\t\t\t\t";
        // line 41
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "_password", array()), 'widget', array("attr" => array("placeholder" => "Contraseña")));
        echo "
\t\t\t\t\t\t\t\t";
        // line 43
        echo "\t\t\t\t</div>
...
\t\t";
        ...
        if ((isset($context["error"]) ? $context["error"] : $this->getContext($context, "error"))) {
            // line 52
            echo "\t\t";
            $context["mensajeError"] = $this->getAttribute((isset($context["error"]) ? $context["error"] : $this->getContext($context, "error")), "message", array());
            // line 53
            echo "\t\t\t";
