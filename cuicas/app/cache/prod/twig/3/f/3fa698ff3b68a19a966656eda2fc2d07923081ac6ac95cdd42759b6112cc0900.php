...
class __TwigTemplate_3fa698ff3b68a19a966656eda2fc2d07923081ac6ac95cdd42759b6112cc0900 extends Twig_Template
{
    ...
    ";
        ...
        echo "
                <div class=\"error\">";
        // line 32
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "fechaInicio", array()), 'errors');
        echo "</div>
            </div>
        </div>
        <div class=\"row\">
            <div class=\"col-xs-12 col-md-7\">
                <strong>";
        // line 37
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "fechaFinal", array()), 'label');
        echo "</strong>
                ";
        // line 38
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "fechaFinal", array()), 'widget');
        echo "
                <div class=\"error\">";
        // line 39
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "fechaFinal", array()), 'errors');
        echo "</div>
            </div>
        </div>
        ";
