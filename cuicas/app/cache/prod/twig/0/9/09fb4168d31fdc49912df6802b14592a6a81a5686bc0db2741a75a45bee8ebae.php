...
class __TwigTemplate_09fb4168d31fdc49912df6802b14592a6a81a5686bc0db2741a75a45bee8ebae extends Twig_Template
{
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["municipio"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["contactadosSufragio"]) {
                    if (($this->getAttribute($context["contactadosSufragio"], "municipio", array()) == $this->getAttribute($context["municipio"], "id", array()))) {
                        echo twig_escape_filter($this->env, $this->getAttribute($context["contactadosSufragio"], "id_cv", array()), "html", null, true);
                        echo ",";
                        ...
                        if (($this->getAttribute($context["contactadosSufragio"], "mi", array()) != "Ninguna")) {
                            echo twig_escape_filter($this->env, $this->getAttribute($context["contactadosSufragio"], "cantMesas", array()), "html", null, true);
                            echo ",";
                        ...
                        if (($this->getAttribute($context["contactadosSufragio"], "testigos", array()) != "no")) {
