...
class __TwigTemplate_429a00cf99d16b1ac76c11d3025344e67712598027c4996a3d6fdb04e7d75b78 extends Twig_Template
{
    ...
    <div class=\"col-xs-13 col-md-3 col-md-offset-2\">
      <div class=\"row\">
        ...
        // line 105
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("encuestas_datosEncuestaSufragio", array("id_encuesta" => $this->getAttribute((isset($context["encuestaFase2"]) ? $context["encuestaFase2"] : $this->getContext($context, "encuestaFase2")), "id", array()))), "html", null, true);
        ...
        if (($this->getAttribute((isset($context["encuestaFase2"]) ? $context["encuestaFase2"] : $this->getContext($context, "encuestaFase2")), "id", array()) == 0)) {
      ...
      <div class=\"row\">
        <div class=\"col-xs-12\">
         \t<div style=\"width:490px; height:360px; overflow: auto; position:relative; \">
            ...
            \t\t</tr>
              \t";
        // line 126
        $context["contactados"] = $this->getAttribute((isset($context["cv"]) ? $context["cv"] : $this->getContext($context, "cv")), "getContactadosSufragioEncuesta", array(0 => (isset($context["encuesta"]) ? $context["encuesta"] : $this->getContext($context, "encuesta"))), "method");
        // line 127
        echo "            \t\t";
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(range(1, $this->getAttribute((isset($context["cv"]) ? $context["cv"] : $this->getContext($context, "cv")), "cantidadMesas", array())));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cant_mesas"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["gg"]) {
                if (($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 1, 1 => $context["cant_mesas"]), "method") == "si")) {
                    echo "checked";
                }
                if (($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 1, 1 => $context["cant_mesas"]), "method") == "no")) {
                    $context["no1"] = "checked";
                }
            }
            $_parent = $context['_parent'];
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["contactados"]) ? $context["contactados"] : $this->getContext($context, "contactados")));
            foreach ($context['_seq'] as $context["_key"] => $context["gg"]) {
                if (($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 2, 1 => $context["cant_mesas"]), "method") == 0)) {
                    echo "selected";
                }
            }
            $_parent = $context['_parent'];
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["contactados"]) ? $context["contactados"] : $this->getContext($context, "contactados")));
            foreach ($context['_seq'] as $context["_key"] => $context["gg"]) {
                if (($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 2, 1 => $context["cant_mesas"]), "method") == 1)) {
                    echo "selected";
                }
            }
            $_parent = $context['_parent'];
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["contactados"]) ? $context["contactados"] : $this->getContext($context, "contactados")));
            foreach ($context['_seq'] as $context["_key"] => $context["gg"]) {
                if (($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 2, 1 => $context["cant_mesas"]), "method") == 2)) {
                    echo "selected";
                }
            }
            $_parent = $context['_parent'];
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["contactados"]) ? $context["contactados"] : $this->getContext($context, "contactados")));
            foreach ($context['_seq'] as $context["_key"] => $context["gg"]) {
                if (($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 2, 1 => $context["cant_mesas"]), "method") == 3)) {
                    echo "selected";
                }
            }
            $_parent = $context['_parent'];
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["contactados"]) ? $context["contactados"] : $this->getContext($context, "contactados")));
            foreach ($context['_seq'] as $context["_key"] => $context["gg"]) {
                if (($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 5, 1 => $context["cant_mesas"]), "method") == "si")) {
                    echo "checked";
                }
                if (($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 5, 1 => $context["cant_mesas"]), "method") == "no")) {
                    $context["no5"] = "checked";
                }
            }
            $_parent = $context['_parent'];
            ...
            if (($context["cant_mesas"] == 1)) {
                ...
                $context['_seq'] = twig_ensure_traversable((isset($context["contactados"]) ? $context["contactados"] : $this->getContext($context, "contactados")));
                foreach ($context['_seq'] as $context["_key"] => $context["gg"]) {
                    if ($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 3, 1 => $context["cant_mesas"]), "method", true, true)) {
                        echo twig_escape_filter($this->env, trim($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 3, 1 => $context["cant_mesas"]), "method")), "html", null, true);
                    }
                }
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['gg'], $context['_parent'], $context['loop']);
            ...
            if (($context["cant_mesas"] == 1)) {
                ...
                $context['_seq'] = twig_ensure_traversable((isset($context["contactados"]) ? $context["contactados"] : $this->getContext($context, "contactados")));
                foreach ($context['_seq'] as $context["_key"] => $context["gg"]) {
                    if ($this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 4, 1 => $context["cant_mesas"]), "method", true, true)) {
                        echo twig_escape_filter($this->env, $this->getAttribute($context["gg"], "getRepuestaEncuesta", array(0 => 4, 1 => $context["cant_mesas"]), "method"), "html", null, true);
                    }
                }
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['gg'], $context['_parent'], $context['loop']);
        ...
        if ( !(null === (isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            if ((trim($this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "tipoIncidencia", array())) == "ninguna")) {
        ...
        // line 184
        if ( !(null === (isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            if ((trim($this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "tipoIncidencia", array())) == "logistica")) {
                echo "selected=\"selected\"";
            }
        }
        ...
        // line 185
        if ( !(null === (isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            if ((trim($this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "tipoIncidencia", array())) == "seguridad")) {
                echo "selected=\"selected\"";
            }
        }
        ...
        // line 186
        if ( !(null === (isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            if ((trim($this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "tipoIncidencia", array())) == "energia")) {
                echo "selected=\"selected\"";
            }
        }
        ...
        // line 187
        if ( !(null === (isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            if ((trim($this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "tipoIncidencia", array())) == "meteorologicos")) {
                echo "selected=\"selected\"";
            }
        }
        ...
        // line 188
        if ( !(null === (isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            if ((trim($this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "tipoIncidencia", array())) == "cne")) {
                echo "selected=\"selected\"";
            }
        }
        echo ">CNE</option>
        ...
        // line 189
        if ( !(null === (isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            if ((trim($this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "tipoIncidencia", array())) == "otras")) {
                echo "selected=\"selected\"";
            }
        }
        echo ">Otras</option>
        ...
        // line 190
        if ( !(null === (isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            if ((trim($this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "tipoIncidencia", array())) == "resuelta")) {
                echo "selected=\"selected\"";
            }
        }
        ...
        if ( !twig_test_empty((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")))) {
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["incidencias"]) ? $context["incidencias"] : $this->getContext($context, "incidencias")), "getDescripcion", array()), "html", null, true);
        }
        echo "</textarea></td>
              \t</tr>
              </thead>   
