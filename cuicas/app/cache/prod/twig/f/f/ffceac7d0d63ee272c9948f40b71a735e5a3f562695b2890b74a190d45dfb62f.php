...
class __TwigTemplate_ffceac7d0d63ee272c9948f40b71a735e5a3f562695b2890b74a190d45dfb62f extends Twig_Template
{
...
\t\t\t";
        // line 60
        $context["rol"] = $this->getAttribute((isset($context["usuario"]) ? $context["usuario"] : $this->getContext($context, "usuario")), "getRol", array());
        // line 61
        echo "\t\t\t";
        if (($this->getAttribute((isset($context["usuario"]) ? $context["usuario"] : $this->getContext($context, "usuario")), "getRol", array()) == "ROLE_ADMIN")) {
            // line 62
            echo "\t\t\t\t";
        ...
        // line 64
        echo "\t\t\t";
        if (($this->getAttribute((isset($context["usuario"]) ? $context["usuario"] : $this->getContext($context, "usuario")), "getRol", array()) == "ROLE_USUARIO")) {
            // line 65
            echo "\t\t\t\t";
            $context["rol"] = "Usuario";
            // line 66
        ...
        // line 67
        echo "\t\t\t";
        if (($this->getAttribute((isset($context["usuario"]) ? $context["usuario"] : $this->getContext($context, "usuario")), "getRol", array()) == "ROLE_SUPERVISOR")) {
            // line 68
            echo "\t\t\t\t";
