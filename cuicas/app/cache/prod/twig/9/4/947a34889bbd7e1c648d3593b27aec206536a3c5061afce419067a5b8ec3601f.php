...
class __TwigTemplate_947a34889bbd7e1c648d3593b27aec206536a3c5061afce419067a5b8ec3601f extends Twig_Template
{
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cargo"]) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($context["cargo"], "nombre", array()), "html", null, true);
            echo "</option>
\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["circuito"]) {
            // line 67
            echo "\t\t\t\t\t\t<option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($context["circuito"], "id", array()), "html", null, true);
            echo "\">";
