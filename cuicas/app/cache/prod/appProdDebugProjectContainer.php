...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '170.179.40.151', 'port' => NULL, 'dbname' => 'sistema_encuesta', 'user' => 'cuicas_prod', 'password' => 'p4Ra1ag0b3rn4c10ng@lb4', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_b669064c9cab866553215800dfc163b4');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b669064c9cab866553215800dfc163b4');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_b669064c9cab866553215800dfc163b4');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/SistemaEncuesta/UsuarioBundle/Entity'), 1 => ($this->targetDirs[3].'/src/SistemaEncuesta/EncuestasBundle/Entity')));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'SistemaEncuesta\\UsuarioBundle\\Entity');
        $f->addDriver($e, 'SistemaEncuesta\\EncuestasBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('UsuarioBundle' => 'SistemaEncuesta\\UsuarioBundle\\Entity', 'EncuestasBundle' => 'SistemaEncuesta\\EncuestasBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'f6f9ef3347f2ad45b2d8b923fc82c4d093366a99');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('SistemaEncuesta\\UsuarioBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 10))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_FrontendService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/perfil/*');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/verPerfil/*');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/encuestasTotal/*');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/buscarPorNombre/*');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/buscarPorFecha/*');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/crearPreguntas/*');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/cargarMunicipios/*');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/cargarParroquias/*');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/cargarCV/*');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/datosEncuesta/*');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/datosEncuestaSufragio/*');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/crear/BuscarPorNombreEncuesta/*');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/cargarCandidato/BuscarPorNombreCandidato/*');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/resumen/*');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/verDetallesEncuesta/*');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/editarDatos/*');

        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/*');

        $y = new \Symfony\Component\HttpFoundation\RequestMatcher('^/encuestas/*');

        $z = new \Symfony\Component\HttpFoundation\RequestMatcher('^/mapas/*');

        $aa = new \Symfony\Component\Security\Http\AccessMap();
        $aa->add($g, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $aa->add($h, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_SUPERVISOR', 2 => 'ROLE_ADMIN'), NULL);
        $aa->add($i, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_SUPERVISOR', 2 => 'ROLE_ADMIN'), NULL);
        $aa->add($j, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_SUPERVISOR', 2 => 'ROLE_ADMIN'), NULL);
        $aa->add($k, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_SUPERVISOR', 2 => 'ROLE_ADMIN'), NULL);
        $aa->add($l, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_SUPERVISOR', 2 => 'ROLE_ADMIN'), NULL);
        $aa->add($m, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($n, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($o, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($p, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($q, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($r, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($s, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($t, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($u, array(0 => 'ROLE_SUPERVISOR', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($v, array(0 => 'ROLE_SUPERVISOR', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($w, array(0 => 'ROLE_USUARIO', 1 => 'ROLE_ADMIN'), NULL);
        $aa->add($x, array(0 => 'ROLE_ADMIN'), NULL);
        $aa->add($y, array(0 => 'ROLE_ADMIN'), NULL);
        $aa->add($z, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERVISOR'), NULL);

        $ba = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $ca = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $ba, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($ba, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'usuario_logout'));
        $ca->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $da = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($ba, array('login_path' => 'usuario_login', 'default_target_path' => 'sistema_Encuesta_principal_homepage', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $da->setProviderKey('frontend');

        return $this->services['security.firewall.map.context.frontend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($aa, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.usuarios')), 'frontend', $a, $c), 2 => $ca, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $ba, 'frontend', $da, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $ba, array('login_path' => 'usuario_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'usuario_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '566369cbe7edb', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $aa, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $ba, 'frontend', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $ba, 'usuario_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/SistemaEncuesta/UsuarioBundle/Resources/translations/messages.es.xliff'), 'es', 'messages');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/SistemaEncuesta/UsuarioBundle/Resources/translations/validators.en.xliff'), 'en', 'validators');
        $instance->addResource('xliff', ($this->targetDirs[3].'/src/SistemaEncuesta/UsuarioBundle/Resources/translations/messages.en.xliff'), 'en', 'messages');
        $instance->addResource('xliff', ($this->targetDirs[2].'/Resources/translations/validators.en.xliff'), 'en', 'validators');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SistemaEncuesta/PrincipalBundle/Resources/views'), 'SistemaEncuestaPrincipal');
        $instance->addPath(($this->targetDirs[3].'/src/SistemaEncuesta/UsuarioBundle/Resources/views'), 'Usuario');
        $instance->addPath(($this->targetDirs[3].'/src/SistemaEncuesta/EncuestasBundle/Resources/views'), 'Encuestas');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SistemaEncuesta/MapasEstadisticosBundle/Resources/views'), 'MapasEstadisticos');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f6f9ef3347f2ad45b2d8b923fc82c4d093366a99');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.usuarios'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'SistemaEncuesta\\UsuarioBundle\\Entity\\Usuario', 'email', NULL);
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'))), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => ($this->targetDirs[3].'/src/SistemaEncuesta/UsuarioBundle/Resources/config/validation.yml'))))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SistemaEncuestaPrincipalBundle' => 'SistemaEncuesta\\PrincipalBundle\\SistemaEncuestaPrincipalBundle',
                'UsuarioBundle' => 'SistemaEncuesta\\UsuarioBundle\\UsuarioBundle',
                'EncuestasBundle' => 'SistemaEncuesta\\EncuestasBundle\\EncuestasBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'PsPdfBundle' => 'Ps\\PdfBundle\\PsPdfBundle',
                'MapasEstadisticosBundle' => 'SistemaEncuesta\\MapasEstadisticosBundle\\MapasEstadisticosBundle',
            ...
            'database_host' => '170.179.40.151',
            'database_port' => NULL,
            'database_name' => 'sistema_encuesta',
            'database_user' => 'cuicas_prod',
            'database_password' => 'p4Ra1ag0b3rn4c10ng@lb4',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'es',
            'secret' => 'f6f9ef3347f2ad45b2d8b923fc82c4d093366a99',
            'sistema_encuesta.directorio.imagenescandidatos' => ($this->targetDirs[2].'/../web/imagenes/fotosCandidatos/'),
            ...
            'kernel.secret' => 'f6f9ef3347f2ad45b2d8b923fc82c4d093366a99',
            ...
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => ($this->targetDirs[3].'/src/SistemaEncuesta/UsuarioBundle/Resources/config/validation.yml'),
            ),
